...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default="/DATA/disk1/hyperplane/Depth_C2RP/Data/Data_0201/",
                             help='see lib/dataset/dataset_facotry for ' + 
                            'available datasets')
    self.parser.add_argument("--add_dataset", default=None, help="add more data if required")
    self.parser.add_argument('--val_dataset', default="/DATA/disk1/hyperplane/Depth_C2RP/Data/franka_validation_0301/")
    self.parser.add_argument("--infer_dataset", default = "/DATA/disk1/hyperplane/Depth_C2RP/Data/3090_shiqian_syn_test/")
    self.parser.add_argument("--syn_dataset", default=None)
    self.parser.add_argument("--kps_name", default="dream_7")
    self.parser.add_argument("--depth_dataset",default="")
    self.parser.add_argument("--pure_dataset", default=None)
    self.parser.add_argument('--root_dir', type=str, default="/DATA/disk1/hyperplane/robot_pose_3090/center-dream/")
    ...
    self.parser.add_argument('--shared_ca', action="store_true")
    ...
    self.parser.add_argument('--ks4', default=1)
    self.parser.add_argument('--ks5', default=1)
    self.parser.add_argument('--ks6', default=1)
    ...
    self.parser.add_argument('--k_list_4', type=int, default=1)
    self.parser.add_argument('--k_list_5', type=int, default=1)
    self.parser.add_argument('--k_list_6', type=int, default=1)
    ...
    self.parser.add_argument('--max_iters', type=float, default=6e5, help="dacay the learning rate")
...
#    opt.num_workers = 1
  ...
  def update_dataset_info_and_set_heads(self, opt, num_categories, resolution=None):
